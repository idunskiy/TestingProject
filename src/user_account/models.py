...
class User(AbstractUser):
    ...
    def percentage_of_successful_runs_for_user(self):
        ...
        if all_test_results.count() is 0:
            return 'No results'
        else:
